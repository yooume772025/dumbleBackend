                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >Select Service<span class="inputlabelmedetory">*</span></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >Sub Service Name<span class="inputlabelmedetory">*</span></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >logo<span class="inputlabelmedetory">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="name" class="form-control name" id="" required>
                                            <option value="">Select Service</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label >Sub Service Name<span
                                                class="inputlabelmedetory">*</span></label>
                                        <input type="text" class="form-control subname" id="subname" name="subname"
                                            required>
                                    </div>
                                </div>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    var table = $('#dataTable').DataTable({
                        ...
                        "ajax": {
                            "url": "{{ route('user.subservice.ajaxcall') }}",
                            "type": "GET",
                            "datatype": "json",
                            "data": function(d) {
                    ...
                    $('#saveform').validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                url: "{{ route('user.sub-service-save') }}",
                                dataType: "json",
                                type: "post",
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.status == 'success') {
                                    ...
                                    $('.name').val(response.data.service_id);
                                    $('.subname').val(response.data.sub_service_name);
                    ...
                    $('#updateform').validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                url: "{{ route('user.subserviceupdate') }}",
                                dataType: "json",
                                type: "post",
                                data: new FormData(form),
                                processData: false,
