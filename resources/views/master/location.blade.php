                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >City Name<span class="inputlabelmedetory">*</span></label>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label >Location Name<span class="inputlabelmedetory">*</span></label>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    var table = $('#dataTable').DataTable({
                        ...
                        "ajax": {
                            "url": "{{ route('user.location.ajaxcall') }}",
                            "type": "GET",
                            "datatype": "json",
                            "data": function(d) {
