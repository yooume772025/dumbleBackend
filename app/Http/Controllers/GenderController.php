...
class GenderController extends Controller
{
    ...
    public function genderAjaxcall(Request $request)
    {
    ...
    public function genderSave(Request $request)
    {
        $params = $request->all();
        $validator = Validator::make(
            $params,
            [
                'name' => 'required|unique:gender_master,gender_name',
            ]
        );
        ...
        $data = [
            'gender_name' => $request->name,
        ];

        $data = Gender::create($data);
    ...
    public function genderUpdate(Request $request)
    {
        ...
        $messages = [
            'name.unique' => 'The gender name must be unique. 
             This gender name already exists.',
        ...
        $validator = Validator::make(
            $params,
            [
                'name' => 'required|unique:gender_master,gender_name,' . $request->id,
            ],
            $messages
        );
        ...
        $data = Gender::where('id', $request->id)->update($data);
