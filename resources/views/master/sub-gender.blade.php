                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >Select Gender<span class="inputlabelmedetory">*</span></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >Sub Gender Name<span class="inputlabelmedetory">*</span></label>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    var table = $('#dataTable').DataTable({
                        ...
                        "ajax": {
                            "url": "{{ route('user.subgender.ajaxcall') }}",
                            "type": "GET",
                            "datatype": "json",
                            "data": function(d) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.status == 'success') {
                                    ...
                                    $('.name').val(response.data.sub_gender_name);
                    ...
                    $('#updateform').validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                url: "{{ route('user.subgenderupdate') }}",
                                dataType: "json",
                                type: "post",
                                data: new FormData(form),
                                processData: false,
