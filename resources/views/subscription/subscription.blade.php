                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >Subscription Name<span class="inputlabelmedetory">*</span></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >Subscription Product ID<span
                                            class="inputlabelmedetory">*</span></label>
                                    <input type="text" class="form-control" id="name" name="product_id" required>
                                </div>
                            </div>

                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >Subscription Product Type<span
                                            class="inputlabelmedetory">*</span></label>
                                    <select name="product_type" id="" class="form-control product_type">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >Price<span class="inputlabelmedetory">*</span></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >Duration<span class="inputlabelmedetory">*</span></label>
                                    <input type="text" class="form-control" id="name" name="duration" required>
                                </div>
                            </div>

                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label >Description<span class="inputlabelmedetory">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label >Subscription Product ID<span
                                                class="inputlabelmedetory">*</span></label>
                                        <input type="text" class="form-control product_id" id="name"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label >Price<span class="inputlabelmedetory">*</span></label>
                                        <input type="text" class="form-control price" id="name" name="price"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label >Duration<span class="inputlabelmedetory">*</span></label>
                                        <input type="text" class="form-control duration" id="name"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label >Description<span class="inputlabelmedetory">*</span></label>
                                        <input type="text" class="form-control description" id="name"
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    var table = $('#dataTable').DataTable({
                        ...
                        serverSide: true,
                        "ajax": {
                            "url": "{{ route('user.subscription.ajaxcall') }}",
                            "type": "GET",
                            "datatype": "json",
                            "data": function(d) {
                    ...
                    $('body').on('click', '.update', function() {
                        ...
                        $.ajax({
                            url: "{{ route('user.getsubscription') }}",
                            dataType: "json",
                            type: "get",
                            data: {
                                'update': id
                    ...
                    $('#updateform').validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                url: "{{ route('user.subscriptionupdate') }}",
                                dataType: "json",
                                type: "post",
                                data: new FormData(form),
                                processData: false,
