                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >Pronounce<span class="inputlabelmedetory">*</span></label>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    var table = $('#dataTable').DataTable({
                        ...
                        "ajax": {
                            "url": "{{ route('user.pronounce.ajaxcall') }}",
                            "type": "GET",
                            "datatype": "json",
                            "data": function(d) {
                    ...
                    $('#updateform').validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                url: "{{ route('user.Pronounceupdate') }}",
                                dataType: "json",
                                type: "post",
                                data: new FormData(form),
                                processData: false,
