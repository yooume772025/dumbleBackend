...
class LanguageController extends Controller
{
    ...
    public function languageSave(Request $request)
    {
        ...
        $validator = Validator::make(
            $params,
            [
                'name' => 'required|unique:language_master,name',
            ]
        );
    ...
    public function languageAjaxcall(Request $request)
    {
    ...
    public function getlanguage(Request $request)
    {
        ...
        if ($update) {
            $data = Language::where('id', $update)->first();
        }

        if ($delete) {
            $data = Language::where('id', $delete)->delete();
        }
    ...
    public function languageUpdate(Request $request)
    {
        ...
        $messages = [
            'name.unique' => 'The labguage name must be unique.
             This language name already exists.',
        ...
        $validator = Validator::make(
            $params,
            [
                'name' => 'required|unique:language_master,name,' . $request->id,
            ],
            $messages
        );
        ...
        $data = Language::where('id', $request->id)->update($data);
