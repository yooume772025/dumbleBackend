            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    var table = $('#dataTable').DataTable({
                        ...
                        "ajax": {
                            "url": "{{ route('user.education.ajaxcall') }}",
                            "type": "GET",
                            "datatype": "json",
                            "data": function(d) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.status == 'success') {
                                    ...
                                    $('.name').val(response.data.education);
                    ...
                    $('#updateform').validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                url: "{{ route('user.educationupdate') }}",
                                dataType: "json",
                                type: "post",
                                data: new FormData(form),
                                processData: false,
