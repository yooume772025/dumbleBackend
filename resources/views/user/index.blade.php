                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Name<span class="inputlabelmedetory">*</span></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Mobile<span class="inputlabelmedetory">*</span></label>
                            ...
                            <div class="col-sm-6 mt-3">
                                <div class="form-group">
                                    <label>Email<span class="inputlabelmedetory">*</span></label>
                            ...
                            <div class="col-sm-6 mt-3">
                                <div class="form-group">
                                    <label>Password<span class="inputlabelmedetory">*</span></label>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Name<span class="inputlabelmedetory">*</span></label>
                                    <input type="text" class="form-control name" id="name1" name="name" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Mobile<span class="inputlabelmedetory">*</span></label>
                                    <input type="text" class="form-control mobile" id="mobile1" name="mobile">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 mt-3">
                                <div class="form-group">
                                    <label>Email<span class="inputlabelmedetory">*</span></label>
                                    <input type="email" class="form-control email" id="email1" name="email"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 mt-3">
                                <div class="form-group">
                                    <label>Password<span class="inputlabelmedetory"></span></label>
                                    <input type="password" class="form-control password" id="password1" name="password"
                                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;">
                                </div>
                            </div>
    ...
    @push('scripts')
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('body').on('click', '.suspendacc', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.status == 'success') {
                                ...
                                $('.password').val(response.data.show_password);
