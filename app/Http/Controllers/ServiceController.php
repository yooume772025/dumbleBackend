...
class ServiceController extends Controller
{
    ...
    public function serviceSave(Request $request)
    {
        ...
        $validator = Validator::make(
            $params,
            [
                'name' => 'required|unique:service_master,name',
            ]
        );
    ...
    public function serviceAjaxcall(Request $request)
    {
    ...
    public function serviceupdate(Request $request)
    {
        ...
        $validator = Validator::make(
            $params,
            [
                'name' => 'required|unique:service_master,name,' . $request->id . ',id',
            ]
        );
        ...
        $insert = Service::where('id', $request->id)->update($data);
