                ...
                <form id="saveform" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >Short Name<span class="inputlabelmedetory">*</span></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label >ISO Code<span class="inputlabelmedetory">*</span></label>
                                    <input type="text" class="form-control" name="iso_code" required>
                                </div>
                            </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.status == 'success') {
                                    ...
                                    $('#short_name').val(response.data.iso_code);
                                    $('#iso_code').val(response.data.country_code);
